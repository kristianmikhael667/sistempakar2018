...
<div id="content">
  ...
  <a class="navbar-brand mr-1" href="index.html"><i class="fa fa-lock"></i> Admin</a>
...
<button class="btn btn-link btn-sm text-white order-1 order-sm-0" id="sidebarToggle" href="#">
  <i class="fas fa-bars"></i>
    ...
    <ul class="navbar-nav ml-auto mt-auto">
      ...
      <a href="#" class="nav-link dropdown-toggle"><i class="fa fa-user fa-sm text-white-50"></i> Status : <span class="mr-2 d-none d-lg-inline text-dark-600 large text-dark">
            <?php
